...
import com.atcast.service.VisitService;
import com.opensymphony.xwork2.ModelDriven;

/**
 * 客户拜访的控制器
 * 
 * @author Administrator Controller(value="visitAction") =
 *         <bean id="visitAction" class="..." scope="">
 */
...
public class VisitAction extends BaseAction implements ModelDriven<Visit> {
	...
	/**
	 * 分页的查询 查询客户的拜访记录，根据用户的主键查询 select * from sale_visit where visit_user_id = ?
	 * 
	 * @return
	 */
